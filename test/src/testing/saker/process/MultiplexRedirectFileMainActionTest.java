...
@SakerTest
public class MultiplexRedirectFileMainActionTest extends MainActionTestCase {
	...
	protected void runTestOnRepo(SakerRepository repo) throws Exception {
		...
		repo.executeAction("main", "-bundle", "saker.process.test.bundle-v1", "-class",
				"testing.saker.process.test.bundle.MultiplexRedirectFileMain",
				"-Unest.params.bundles=" + parameterBundlesString, jarpath.toString(), outputpath.toString());
