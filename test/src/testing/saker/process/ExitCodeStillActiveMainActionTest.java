...
@SakerTest
public class ExitCodeStillActiveMainActionTest extends MainActionTestCase {
	...
	protected void runTestOnRepo(SakerRepository repo) throws Exception {
		...
		repo.executeAction("main", "-bundle", "saker.process.test.bundle-v1", "-class",
				...
				jarpath.toString(), "259");
		assertEquals(System.clearProperty(UUID), "259");
	}
}
